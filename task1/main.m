...
[t3, X3] = ode45(@(t, X) func(t,a0,a1,a2,a3,b0,2*sin(t),X), t_interval, y0);
[t4, X4] = ode45(@(t, X) func(t,a0,a1,a2,a3,b0,2*sin(t),X), t_interval, y1);

figure(1)
plot(t1, X1(:, 1), "Color",'b','LineStyle','-','LineWidth',1)
title('Входной сигнал f(t) = 1(t); нулевые Н.У.')
hold on
...
title('Входной сигнал f(t) = 1(t); Н.У.: y(0) = 1, y''(0) = 0.5, y''''(0) = -1.')
hold on
...
title('Входной сигнал g(t) = 2*sin(t); нулевые Н.У.')
hold on
...
title('Входной сигнал g(t) = 2*sin(t); Н.У.: y(0) = 1, y''(0) = 0.5, y''''(0) = -1.')
hold on
